...
(function () {
  ...
  function resolveConceptLink(href, conceptId) {
    ...
    return nodeIndex[target] ? target : null;
  }
  ...
  function rewriteInternalLinks(root, conceptId) {
    root.querySelectorAll("a[href]").forEach((a) => {
      ...
      if (!href) return;
      const target = resolveConceptLink(href, conceptId);
      if (target) {
