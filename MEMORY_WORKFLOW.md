...
Knowledge Format (OKF) concepts under `second-brain/`.
...
1. Read `second-brain/index.md` and search the bundle for related terms.
...
7. Run `okf index second-brain`.
8. Run `okf check second-brain`.
